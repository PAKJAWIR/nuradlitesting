  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-20 p-5 mt-20">
      ...
      <div className="md:w-1/2 flex flex-col gap-1">
        ...
        <p className={classPara}>Get in touch with me for any inquiries or collaboration opportunities. I'm here to discuss your project needs, answer your questions, and explore how we can work together to achieve your goals.</p>
        ...
        <div className="text-warna3 space-y-4 mt-6">
          <div>
            ...
            <p className={classPara}>Kabupaten Bogor, Jawa Barat 16340, Indonesia</p>
          </div>
          <div>
            <h3 className="font-semibold text-lg">Phone</h3>
            <p className={classPara}>+62 123123</p>
          </div>
          <div>
            <h3 className="font-semibold text-lg">Email</h3>
            <p className={classPara}>exam@gmail.com</p>
          </div>
        </div>
      </div>
